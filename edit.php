    ...
    <div class="container">
      ...
      <form id="creat-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
        ...
        <div class="form-group">
          ...
          <textarea type="text" class="form-control" id="observations" name="observations" placeholder="Digite a descrição do contato" rows="3"><?= $contact['observations'] ?></textarea>
        </div>
